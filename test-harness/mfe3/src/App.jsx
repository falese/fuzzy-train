...
const App = () => {
  ...
  React.useEffect(() => {
    ...
    console.log(`[mfe3] MUI ${muiVersion} loaded from ${info.source} in ${loadTime}ms`);
    
    // Log performance mark
    performance.mark(`mfe3-mui-loaded`);
  }, []);
          ...
          {depInfo.loading ? (
            ...
            <>
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={() => alert(`mfe3 using MUI ${depInfo.version} from ${depInfo.source}`)}
              >
                MUI Button
              </Button>
            </>
